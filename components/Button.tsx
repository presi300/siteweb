...
const Button = ({
  ...
  const getButtonClass = () => {
    switch (variant) {
      ...
      case "ghost":
        return "bg-slate-900 border border rounded-l border-slate-800 py-3 px-4 inline-flex w-full ustify-center items-center gap-2 rounded-sm font-semibold text-white hover:bg-slate-800 focus:outline-none transition-all text-sm";
      case "solid-black":
